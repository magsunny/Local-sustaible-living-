...
const loginFormRef = useRef(true);
...
useEffect(() => {
  ...
  const pageClickEvent = (e) => {
    if (loginFormRef.current !== null && !loginFormRef.current.contains(e.target)) {
      ...
      console.log(loginFormRef.current.contains(e.target));
  ...
  <div className="relative flex justify-center items-center">
    ...
    <div ref={loginFormRef} className={`px-4 absolute rigth-0 top-16 w-80 flex min-h-full items-center justify-center z-10 bg-slate-100 text-center rounded-xl shadow-xl
