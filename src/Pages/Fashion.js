                ...
                <div>
                  ...
                  {Content.map((item,id)=>(
                    <div className="border-t border-gray-200 pt-4">
                      ...
                      <dd className="mt-2 text-sm text-gray-500 hover:text-gray-700 visited:text-gray-300 h-80 sm:h-96"><a href ='https://www.hamburg.de/fahrradfahren-in-hamburg/16219442/radnetze/'target='_blank' rel="noreferrer"> {item.text} </a></dd>
